...
public class BulletPool : MonoBehaviour
{
    ...
    public void ShootObject(Vector2 transform, Quaternion rotation, BulletTypeScriptable bulletType)
    {
        ...
        bullet.transform.SetLocalPositionAndRotation(transform, rotation);
    }
}
